...
- [Simulating Basic Geometry](https://github.com/buddhadeb33/Project_Computer-Graphics): Simulating basic geometry using ThreeJS, Vanilla JavaScript and jQuery.
- [Website Selling Food](https://github.com/ZiDuck/Website-Selling-Food): Final project of web application development.
- [Pokemon Shopping Cart](https://github.com/buddhadeb33/Shopping-Cart): Learn Typescript from scratch.
