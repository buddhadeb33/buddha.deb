  ...
  return (
    <div>
      <ul id="bios" className="hidden">
        <li>
          I'm aliased as <b className="font-medium">buddha</b> at work.
        </li>
        <li>
          I live in <b className="font-medium">Bengal, India</b>.
        </li>
        <li>
          I was born in the beautiful <b className="font-medium">West Bengal</b>.
        </li>
        <li>
          My first programming language I learned was <b className="font-medium">Python</b>.
        </li>
        <li>I love AI development.</li>
        <li>
